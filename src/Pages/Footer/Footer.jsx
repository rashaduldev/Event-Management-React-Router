...
const Footer = () => {
    return (
        <div className='mx-10 mt-10'>
            <footer className="footer p-10 bg-base-200 text-base-content" data-aos="zoom-in-up">
  <nav>
  ...
  <nav>
    ...
    <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 items-center">
  <aside className="items-center grid-flow-col">
    ...
    <p>Educative <br/>Providing reliable tech since 2023</p>
  </aside> 
  <div>
  <aside className="items-center grid-flow-col">
